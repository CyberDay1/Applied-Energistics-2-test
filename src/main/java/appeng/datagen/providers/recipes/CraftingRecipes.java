...
public class CraftingRecipes extends AE2RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput consumer) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AEBlocks.STORAGE_BUS)
                .pattern("cpc")
                .pattern("bcb")
                .pattern("cpc")
                ...
                .unlockedBy("has_logic_processor", has(AEItems.LOGIC_PROCESSOR))
                .save(consumer, AppEng.makeId("network/blocks/storage_bus"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AEBlocks.IMPORT_BUS)
                .pattern("chc")
                .pattern("pcp")
                .pattern("chc")
                ...
                .unlockedBy("has_calculation_processor", has(AEItems.CALCULATION_PROCESSOR))
                .save(consumer, AppEng.makeId("network/blocks/import_bus"));
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AEBlocks.EXPORT_BUS)
                .pattern("chc")
                .pattern("pcp")
                .pattern("chc")
                .define('h', Items.HOPPER)
                ...
                .unlockedBy("has_engineering_processor", has(AEItems.ENGINEERING_PROCESSOR))
                .save(consumer, AppEng.makeId("network/blocks/export_bus"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, AEBlocks.CRAFTING_CPU)
                .pattern("qeq")
                .pattern("clc")
                .pattern("qeq")
